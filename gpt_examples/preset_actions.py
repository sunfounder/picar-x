...
def wave_hands(car):
    car.reset()
    car.set_camera_tilt_angle(20)
    for _ in range(2):
        car.set_steering_angle(-25)
        sleep(.1)
...
def resist(car):
    car.reset()
    car.set_camera_tilt_angle(10)
    for _ in range(3):
        car.set_steering_angle(-15)
        car.set_camera_pan_angle(15)
        sleep(.1)
        car.set_steering_angle(15)
        car.set_camera_pan_angle(-15)
        sleep(.1)
...
def think(car):
    ...
    for i in range(11):
        car.set_camera_pan_angle(i*3)
        car.set_camera_tilt_angle(-i*2)
        car.set_steering_angle(i*2)
        sleep(.05)
    sleep(1)
    car.set_camera_pan_angle(15)
    car.set_camera_tilt_angle(-10)
...
def shake_head(car):
    car.stop()
    car.set_camera_pan_angle(0)
    car.set_camera_pan_angle(60)
    sleep(.2)
    car.set_camera_pan_angle(-50)
    sleep(.1)
    car.set_camera_pan_angle(40)
    sleep(.1)
    car.set_camera_pan_angle(-30)
    sleep(.1)
    car.set_camera_pan_angle(20)
    sleep(.1)
    car.set_camera_pan_angle(-10)
    sleep(.1)
    car.set_camera_pan_angle(10)
    sleep(.1)
