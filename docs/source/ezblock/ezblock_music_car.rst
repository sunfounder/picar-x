...
Pour implémenter plusieurs jugements conditionnels, remplacez le bloc simple if do par un bloc if else do / else if do. Cela se fait en cliquant sur l'icône des paramètres comme indiqué ci-dessus.
